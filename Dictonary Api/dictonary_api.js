console.log("this is dictonary api js file ");
...
function populate() {
    ...
    results.forEach(element => {
        ...
        html += `<li class="list-group-item list-group-item-action list-group-item-info">
    One of the defination from results object is , <strong>(${element.definition}). </strong></li>`
